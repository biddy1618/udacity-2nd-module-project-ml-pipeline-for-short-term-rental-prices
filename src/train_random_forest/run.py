...
def go(args):
    ...
    artifact = wandb.Artifact(
        ...
        description=args.artifact_model_description,
        metadata=rf_config
    )
...
def get_inference_pipeline(rf_config, max_tfidf_features, quantile):
    # Let's handle the categorical features first
    # Ordinal categorical are categorical values for which the order is meaningful, for example
    # for room type: 'Entire home/apt' > 'Private room' > 'Shared room'
    ordinal_categorical = ['room_type']
    non_ordinal_categorical = ['neighbourhood_group']
    non_ordinal_categorical_high_cardinality = ['neighbourhood']
    ...
    non_ordinal_categorical_high_card_preproc = make_pipeline(
        ...
        reshape_to_1d,
        MeanTargetEncoder(quantile=quantile)
    )
    ...
    processed_features = ordinal_categorical + non_ordinal_categorical + \
        non_ordinal_categorical_high_cardinality + zero_imputed + ['last_review', 'name']
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Training random forest model')
    ...
    parser.add_argument(
        '--quantile',
        help='Quantile reference for mean encodind high-cardinality feature `neighbourhood`',
        default=0.9,
        type=float
    )
    ...
    parser.add_argument(
        '--artifact_model_type',
        type=str,
        help='Type for the output serialized model',
        required=True,
    )
    ...
    parser.add_argument(
        ...
        type=str,
        help='Description for the output serialized model',
        required=True,
    )
